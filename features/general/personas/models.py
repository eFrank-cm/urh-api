...
class Persona(SQLModel, table=True):
    ...
    celular: str
    email: str
    correo_institucional: str | None = Field(sa_column=Column("correoinstitucional", String))
    ...
    ubigeo: str
    tipo_documento_identidad: str = Field(sa_column=Column("tipodocumentoidentidad", String))
    estado: bool
    fecha: datetime
    fecha_defuncion: datetime = Field(sa_column=Column("fechadefuncion", String))
    ubigeonac: str
    usuario: str
